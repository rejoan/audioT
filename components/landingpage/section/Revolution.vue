                ...
                <v-col cols="12" md="9" class="text-center">
                    ...
                    <div class="mt-6 d-sm-flex gap-3 justify-center" data-aos="fade-up" data-aos-delay="800"
                        ...
                        <v-btn to="" v-scroll-to="'#demos'" color="primary" rounded="pill"
                            ...
                            Preview</v-btn>
                        <v-btn target="_blank" rounded="pill" variant="outlined" href="https://demos.wrappixel.com/premium-admin-templates/nuxtjs/spike-nuxtjs/docs/index.html" color="primary" size="large"
