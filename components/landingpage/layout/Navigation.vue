...
<template>
    ...
    <v-btn variant="text" color="primary" class="custom-hover-primary nav-links" :ripple="false" href="https://demos.wrappixel.com/premium-admin-templates/nuxtjs/spike-nuxtjs/docs/index.html" target="_blank">Documentation</v-btn>
    <v-btn variant="text" color="primary" class="custom-hover-primary nav-links" :ripple="false" href="https://support.wrappixel.com/" target="_blank">Support</v-btn>
